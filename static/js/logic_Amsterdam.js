  ...
  if (Amsterdam[i].guest_satisfaction_overall < 90) {
    ...
    lowsatisfactionMarkers.push(
      L.marker(
        ...
        ).bindPopup("<h1>" + "€ " + Amsterdam[i].realSum.toFixed(2) + "</h1>" +"\n"
        + "<h2>" +"rating: " + Amsterdam[i].guest_satisfaction_overall + "</h2>"+"\n"
        + "<h2>" +"bedrooms: " + Amsterdam[i].bedrooms+ "</h2>"));
  }
}

for (var i = 0; i < Amsterdam.length; i++) {
  if ((90 <= Amsterdam[i].guest_satisfaction_overall) && (Amsterdam[i].guest_satisfaction_overall < 100)) {
    // loop through the cities array, create a new marker, and push it to the cityMarkers array
...
for (var i = 0; i < Amsterdam.length; i++) {
  if (100 <= Amsterdam[i].guest_satisfaction_overall) {
    // loop through the cities array, create a new marker, and push it to the cityMarkers array
